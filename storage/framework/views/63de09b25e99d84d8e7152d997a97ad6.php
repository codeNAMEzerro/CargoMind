<?php $__env->startSection('title', 'Cek Inventory'); ?>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="flex gap-1">
            <a href="?filter=low_stock" class="btn btn-sm <?php echo e(request('filter') == 'low_stock' ? 'btn-danger' : 'btn-secondary'); ?>">
                <i class="ri-error-warning-fill"></i> Stok Menipis
            </a>
            <?php if(request('filter') || request('search')): ?>
                <a href="<?php echo e(route('inventory.index')); ?>" class="btn btn-sm btn-secondary">Reset</a>
            <?php endif; ?>
        </div>
    </div>
    <div class="card-body">
        <form class="search-bar" method="GET">
            <input type="text" name="search" class="form-control" placeholder="Cari nama atau SKU..." value="<?php echo e(request('search')); ?>">
        ...
        <div class="inventory-grid">
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="inventory-card <?php echo e(auth()->user()->hasRole('master') || auth()->user()->hasRole('manager') ? 'clickable' : ''); ?>" 
                     <?php if(auth()->user()->hasRole('master') || auth()->user()->hasRole('manager')): ?>
                     onclick="showItemDetail(<?php echo e($item->id); ?>)"
                     <?php endif; ?>>
                    ...
                    <div class="inventory-card-content">
                        <div class="inventory-card-sku"><?php echo e($item->sku ?? '-'); ?></div>
                        <h3 class="inventory-card-name"><?php echo e($item->name); ?></h3>
                        <div class="inventory-card-location">
                            <i class="ri-map-pin-2-line"></i> <?php echo e($item->rack_display); ?>

                        </div>
                        <div class="inventory-card-footer">
                            <div class="inventory-card-price"><?php echo e(format_rupiah($item->price)); ?></div>
                            <div class="inventory-card-stock">
                                <?php if($item->stock <= 10): ?>
                                    <span class="badge badge-danger"><?php echo e($item->stock); ?> Unit</span>
                                <?php else: ?>
                                    <span class="badge badge-success"><?php echo e($item->stock); ?> Unit</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php if(auth()->user()->isMaster()): ?>
                            <div class="inventory-card-purchase-price" style="font-size: 0.75rem; color: var(--text-muted); margin-top: 4px;">
                                Beli: <?php echo e(format_rupiah($item->purchase_price)); ?>
        ...
        <?php if($items->hasPages()): ?>
            <div class="pagination"><?php echo e($items->withQueryString()->links('pagination')); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ILHAM-sama/Documents/CargoMind/CargoMind/resources/views/items/inventory.blade.php ENDPATH**/ ?>